...
const TagCard = ({_id, name, questions, showCount, compact,remove, isButton, handleRemove}: Props) => {
    ...
    const Content = (
        <>
            <Badge className="subtle-medium background-light800_dark300 rounded-md border-none px-4 py-2 uppercase text-light400_light500 flex flex-row gap-2">
                ...
                {remove &&(
                    <Image
                        ...
                        height={12}
                        alt="close"
                        className="dark:invert cursor-pointer object-contain invert-0"
        ...
        <Link href={ROUTES.TAG(_id)} className="shadow-light100_darknone">
            <article className="background-light900_dark200 light-border flex w-full flex-col rounded-2xl border px-8 py-10 sm:w-[260px]">
                ...
                <p className="small-medium text-dark400_light500 mt-3.5">
                    ...
                    <span className="body-seminold primary-text-gradient mr-2.5">
                        {questions}+
                    </span>
                    Questions
