    ...
    return(
        <Form {...form}>
            <form onSubmit={form.handleSubmit(handleSumbit)}
                            ...
                            <FormItem className="flex w-full flex-col gap-2.5">
                                ...
                                <FormControl>
                                    <Input required type={field.name === 'password' ? 'password' : "text"}
                                           {...field}
                                    className="paragraph-regular background-light_900_dark300 light-border-2 text-dark-300_light700
                ...
                <Button disabled={form.formState.isSubmitting} className="primary-gradient paragraph-medium min-h-12 w-full rounded-2 px-4 py-3 font-inter !text-light-900">{form.formState.isSubmitting?
                buttonText === 'Sign In' ? 'Signing In...' : 'Signing Up...' : buttonText}</Button>
